...
urlpatterns = [
    ...
    path("customer-contacts/<int:pk>/update/", CustomerContactUpdateView.as_view(), name="customer-contact-update"),
    path("customer-contacts/<int:pk>/delete/", CustomerContactDeleteView.as_view(), name="customer-contact-delete"),
