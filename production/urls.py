...
urlpatterns = [
    ...
    path(
        "bom-items/<int:pk>/update/", BOMItemUpdateView.as_view(), name="bomitem-update"
    ),
    path(
        "bom-items/<int:pk>/delete/", BOMItemDeleteView.as_view(), name="bomitem-delete"
    ),
    ...
    path(
        "jobs/<int:pk>/update/",
        ProductionUpdateView.as_view(),
        name="production-update",
    ),
    path(
        "jobs/<int:pk>/receive/",
        ProductionReceiveView.as_view(),
